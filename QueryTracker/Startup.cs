...
using QueryTracker.Services;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc.Authorization;
using QueryTracker.Authentication;
using QueryTracker.Authentication.Handlers;

namespace QueryTracker
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
	        ...
	        services.AddAuthorization(options =>
	        {
		        ...
		        options.AddPolicy(PolicyConstants.AdminEmployeePolicy,
			        policy => policy.Requirements.Add(new UserDesignationRequirement(new List<DesignationEnum>() { DesignationEnum.Admin, DesignationEnum.Employee})));
	        });
